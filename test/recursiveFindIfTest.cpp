...
void recursive_find_if_tests()
{
    ...
    assert(TinyDIP::recursive_find_if<2>(word_array1, [](auto&& i) { return i == 'a'; }) == false);
    assert(TinyDIP::recursive_find_if<2>(word_array1, [](auto&& i) { return i == 'b'; }) == false);
    assert(TinyDIP::recursive_find_if<2>(word_array1, [](auto&& i) { return i == 'c'; }) == false);
    assert(TinyDIP::recursive_find_if<2>(word_array1, [](auto&& i) { return i == 'd'; }) == false);
    assert(TinyDIP::recursive_find_if<2>(word_array1, [](auto&& i) { return i == 'e'; }) == false);
    ...
    assert(TinyDIP::recursive_find_if<2>(word_deque1, [](auto&& i) { return i == 'd'; }) == false);
    assert(TinyDIP::recursive_find_if<2>(word_deque1, [](auto&& i) { return i == 'e'; }) == false);
