...
void recursive_remove_copy_if_tests()
{
    ...
    M_Assert(
            TinyDIP::recursive_remove_copy_if<1>(test_string_1, [](auto&& x) { return x == '1'; }) ==
            expected_result_9,
...
//  recursive_remove_copy_if_execution_policy_tests function implementation
void recursive_remove_copy_if_execution_policy_tests()
{
    //  std::vector<int> test case
    std::vector<int> test_vector_1 = {
        1, 2, 3, 4, 5, 6
    ...
    M_Assert(
        TinyDIP::recursive_remove_copy_if<1>(std::execution::par, test_vector_1, [](auto&& x) { return (x % 2) == 0; }) ==
        expected_result_1,
        "std::vector<int> test case failed");
    ...
    M_Assert(
        TinyDIP::recursive_remove_copy_if<2>(std::execution::par, test_vector_2, [](auto&& x) { return (x % 2) == 0; }) ==
        expected_result_2,
        "std::vector<std::vector<int>> test case failed");
    ...
    M_Assert(
        TinyDIP::recursive_remove_copy_if<1>(std::execution::par, test_vector_3, [](auto&& x) { return (x == "1"); }) ==
        expected_result_3,
        "std::vector<std::string> test case failed");
    ...
    M_Assert(
        TinyDIP::recursive_remove_copy_if<2>(std::execution::par, test_vector_4, [](auto&& x) { return (x == "1"); }) ==
        expected_result_4,
        "std::vector<std::vector<std::string>> test case failed");
    ...
    expected_result_5.push_back(6);
    M_Assert(
        TinyDIP::recursive_remove_copy_if<1>(std::execution::par, test_deque_1, [](auto&& x) { return (x == 1); }) ==
        expected_result_5,
        "std::deque<int> test case failed"
    );
    ...
    expected_result_6.push_back(expected_result_5);
    M_Assert(
        TinyDIP::recursive_remove_copy_if<2>(std::execution::par, test_deque_2, [](auto&& x) { return (x == 1); }) ==
        expected_result_6,
        "std::deque<std::deque<int>> test case failed"
    );
    ...
    std::list<int> expected_result_7 = {1, 3, 5};
    M_Assert(
        TinyDIP::recursive_remove_copy_if<1>(std::execution::par, test_list_1, [](int x) { return (x % 2) == 0; }) ==
        expected_result_7,
        "std::list<int> test case failed"
    );
    ...
    M_Assert(
            TinyDIP::recursive_remove_copy_if<2>(std::execution::par, test_list_2, [](int x) { return (x % 2) == 0; }) ==
            expected_result_8,
            "std::list<std::list<int>> test case failed"
        );
