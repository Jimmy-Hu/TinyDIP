...
//  subimage2Test2 function implementation
void subimage2Test2(const std::filesystem::path& file_path, std::string_view output_path)
{
    ...
    auto output_image = TinyDIP::subimage2(image_input, 0, 1919, 360, 1079);
...
int main(int argc, char* argv[])
{
    ...
    else
    {
        ...
        TinyDIP::bmp_write("OutputImages/subimage2Test2", output);
    }
    return EXIT_SUCCESS;
}