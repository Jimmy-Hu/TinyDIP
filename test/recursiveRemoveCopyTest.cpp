...
void recursive_remove_copy_execution_policy_tests()
{
    ...
    expected_result_6.push_back(expected_result_5);
    M_Assert(
        TinyDIP::recursive_remove_copy<2>(std::execution::par, test_deque_2, 1) ==
        expected_result_6,
    ...
    std::list<int> expected_result_7 = {2, 3, 4, 5, 6};
    M_Assert(
        TinyDIP::recursive_remove_copy<1>(std::execution::par, test_list_1, 1) ==
        expected_result_7,
